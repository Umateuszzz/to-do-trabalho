...
<dyad-write path="src/components/TodoList.tsx" description="Fix icon name from MoreVertical2 to MoreVertical">
"use client";
    ...
    <div className="space-y-3">
      {todos.map((todo) => (
        <Card key={todo.id} className="border hover:shadow-md transition-shadow">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="p-1 h-6 w-6 w-6">
                <MoreVertical className="h-3 w-3" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
